...
// Установка категории по умолчанию (для создания расхода через окно "Новый расход")
...
const createCategoryElement = (category) => {
    const $categoryDiv = $categoryTemplate.content.cloneNode(true).querySelector('.category');
...
export { categoriesStorage, setDefaultCategory, fillCategoriesContainer, fillCategoriesSelect};